...
// import { CheckIcon as CheckIcon } from '@heroicons/react/24/outline';
import { FaCheck as CheckIcon } from "react-icons/fa";
// import { StopIcon as CheckBox } from '@heroicons/react/24/outline';
import { MdCheckBoxOutlineBlank as CheckBox} from "react-icons/md";

function HomePage() {
    return (
        <div className={`flex flex-col min-h-[calc(100vh-400px)]`}> // bg-[url('../assets/steps-sky.svg')] bg-fixed
            <HeroSection />
            <Statistics />
            <Headline />
            <FinancialGoals />
...
function HeroSection() {
    return (
        <section className="w-full flex justify-center py-10 from-lime-200 to-moss-200 overflow-hidden">
            <div className="content-center grid md:grid-cols-2 max-w-screen-2xl">
                <div className='z-10 order-last md:order-first flex flex-col justify-center px-4 lg:px-12 lg:mt-40'>
                    <h1 className="font-halogen min-w-[400px] xl:text-5xl text-3xl mb-8">
                        ...
                        <div ></div>
                        is <span style={{ textDecorationSkipInk: 'none' }} className='italic tracking-wide font-black underline underline-offset-[-0.7rem] decoration-sun-400 decoration-[1rem]'>Within Reach</span></h1>
                ...
                <div className='col-span-1'>
                    <img className="h-full max-h-[500px] object-contain saturate-[10%] hue-rotate-180" src={heroImage} alt="" />
                    <div className='z-1 hidden md:block absolute right-[10px] h-[250px] overflow-hidden w-[80px]'>
...
function Statistics() {
    return (
        <section className="w-full flex font-halogen space-x-4 md:space-x-[10vw] text-jet-400 flex-wrap justify-center items-center text-center p-16">
            <div className="p-4">
...
function FinancialGoals() {
    return (
        <section className="w-full flex items-center justify-center my-20 py-10overflow-hidden">
            <div className="flex flex-wrap justify-center items-start space-x-24 max-w-[2000px] px-8 py-4">
                <div className='bg-gradient-to-t from-sun to-sky h-[500px] w-[600px]'>
                    ...
                    {/* <img className="object-cover lg:w-[40vw]" src={financialStepsIsometric} alt="" /> */}
                </div>
                <div className=''>
                    ...
                    <ul className="mt-4 space-y-6 font-poppins font-bold text-md text-earth-600 text-2xl pl-14">
                        <li className='px-4'><CheckIcon className='text-jet z-50 absolute h-16 ml-[-86px] mt-[-28px]' /><CheckBox className='h-10 text-moss z-1 absolute ml-[-75px]' />Raise your credit score.</li>
                        <li className='px-4'><CheckIcon className='text-jet z-50 absolute h-16 ml-[-86px] mt-[-28px]' /><CheckBox className='h-10 text-moss z-1 absolute ml-[-75px]' />Reduce or eliminate credit card debt.</li>
                        <li className='px-4'><CheckIcon className='text-jet z-50 absolute h-16 ml-[-86px] mt-[-28px]' /><CheckBox className='h-10 text-moss z-1 absolute ml-[-75px]' />Start saving money.</li>
                        <li className='px-4'><CheckIcon className='text-jet z-50 absolute h-16 ml-[-86px] mt-[-28px]' /><CheckBox className='h-10 text-moss z-1 absolute ml-[-75px]' />Begin a retirement plan.</li>
                        <li className='px-4'><CheckIcon className='text-jet z-50 absolute h-16 ml-[-86px] mt-[-28px]' /><CheckBox className='h-10 text-moss z-1 absolute ml-[-75px]' />Start college funds for children.</li>
                        <li className='px-4'><CheckIcon className='text-jet z-50 absolute h-16 ml-[-86px] mt-[-28px]' /><CheckBox className='h-10 text-moss z-1 absolute ml-[-75px]' />Buy a home.</li>
                    </ul>
